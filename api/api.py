...
def get_device_token(request, device_code: str):
    try:
        device_login = DeviceLogin.objects.get(device_code=device_code)
    ...
    return {
        "access_token": f"token_for_user_{device_login.user.username}",
        "token_type": "bearer"
    }
